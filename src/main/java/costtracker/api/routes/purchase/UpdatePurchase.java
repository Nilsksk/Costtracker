    ...
    public void addPutHandler(HttpServer server, String path) {
        server.createContext(path, handler -> {
            try (handler) {
                ...
                Double purchasePrice = Double.valueOf(bodyData.getString("price"));
                // TODO: Add json to company/category mapper
                // Company purchaseCompany = bodyData.getString("company");
                // Category purchaseCategory = bodyData.getString("category");
